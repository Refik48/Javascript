...
toplam = 0;
//!  a=herbir dizi elemanı......i=indexi......d=her aşamada toplam
...
//=== iterasyonla eger asil diziyi degistirmek istersek bu sekilde yapabiliriz
fiyatlar.forEach(
...
fiyatlar.forEach((deger, indis, dizi) => {
  dizi[indis] = (deger * 1.1).toFixed(2);
  toplamFiyat += Number(dizi[indis]);
});
...
// map() metodudundan sonra eğer bir terminal işlemi (forEach gibi) kullanılırsa map() metodu bir dizi döndürmez. tuketir (consume)
//pipeline
