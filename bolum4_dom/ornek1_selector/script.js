...
const baslik = document.querySelector(".title"); // ? class'a ulasmak icin . kullanilir
baslik.innerHTML = "DOM Selector 👍 ";

const body = document.querySelector("#body"); // ? id'ye ulasmak icin # kullanilir
...
//! addEventListener()
document.querySelector("#btn").addEventListener("mousever", function () {
  document.querySelector("#btn").buton.style.width = "150px";
});
